      ...
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
          <div className="col-span-1 md:col-span-1">
            <div className="flex items-center space-x-2 mb-6">
              ...
              <span className="text-lg font-black tracking-tight">FLIPKART<span className="text-blue-600">CLONE</span></span>
            </div>
          ...
          <div>
            <h4 className="text-xs font-bold uppercase tracking-widest text-gray-500 mb-6">Shop</h4>
            <ul className="space-y-4 text-sm font-semibold text-gray-300">
              ...
              <li><a href="/" className="hover:text-blue-500 transition-colors">Home & Decor</a></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <div className="flex">
              <input 
                ...
                className="bg-gray-800 border-none rounded-l-lg px-4 py-2 text-sm focus:ring-1 focus:ring-blue-500 w-full"
              />
        ...
        <div className="pt-8 border-t border-gray-800 flex flex-col md:flex-row justify-between items-center gap-4">
          ...
          <div className="flex space-x-6">
            {/* href="#" ah href="/" nu mathiruken build error fix panna */}
